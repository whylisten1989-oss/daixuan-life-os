  ...
  return (
    <div className="mx-auto max-w-[1000px] px-4 py-7 sm:px-6 lg:px-8">
      ...
      <div className="mt-7 divide-y divide-border border-y border-line-strong">
        ...
        <SettingRow icon={Shield} title="数据隔离" description="数据库通过 spaceId、成员关系和 RLS 三层约束。"><span className="text-xs text-success">已设计</span></SettingRow>
        <SettingRow icon={Database} title="Supabase" description="认证、PostgreSQL 与 RLS。"><span className="text-xs text-muted">等待云项目</span></SettingRow>
